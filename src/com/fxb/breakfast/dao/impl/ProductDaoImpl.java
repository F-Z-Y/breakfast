...
public class ProductDaoImpl implements ProductDao{
	...
	public List<Product> getAll() {
		...
		String sql="select g.id,g.name,s.id as seller_id,s.name as seller_name,g.price,g.volume from  goods as g,seller as s where g.seller_id=s.id  and g.status=0; ";
		try {
